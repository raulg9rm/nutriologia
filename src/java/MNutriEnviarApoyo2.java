 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/MNutriEnviarApoyo2"})
public class MNutriEnviarApoyo2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MNutriEnviarApoyo2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MNutriEnviarApoyo2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        ");
        try {
            ...
            out.println("<center></br><br><br><br></br>De: Nutri&oacute;logo. " + nombreN + " " + paternoN + " " + maternoN);
            ...
            out.println("</br></br><label>Mensaje: </label></br>\n"
                    + "        <textarea id=\"men\" rows=\"10\" cols=\"50\"></textarea><br/><br/>"
                    + " <center><br><button class=\"main_btn2\" id=\"button\"  onclick=\"buscarOpcionMNutriEnviarApoyo3(" + id_paciente + ", " + cedula + ");\">Enviar</button></center>");
            out.println("</center><div id=\"mensaje11\"></div><br><br>");
