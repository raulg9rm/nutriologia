 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/MUsuVerNutriAgendar"})
public class MUsuVerNutriAgendar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MUsuVerNutriAgendar</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MUsuVerNutriAgendar at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        <BR><br><br>");
            ...
            while (cdr.next()) {
                out.println("<center>"
                    ...
                    out.println("CEDULA: " + cdr.getString("cedula") + "" + "<br><br>"
                            ...
                            + "<br/><button class=\"main_btn2\" onclick=\"buscarOpcionMUsuWebCitaa("+cdr.getString("cedula")+");\">Hacer cita</button>"
                            + "<br/><br><br><button class=\"main_btn2\" onclick=\"buscarOpcionMUsuWebVerComentarios("+cdr.getString("cedula")+");\">Ver comentarios</button>"
                            + "<br><div id='ini'></div></center><br><br/><br/>");
            }
