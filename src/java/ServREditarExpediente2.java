 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/ServREditarExpediente2"})
public class ServREditarExpediente2 extends HttpServlet {
    ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServREditarExpediente2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServREditarExpediente2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String strComando="UPDATE expediente set altura='"+altura+"', sexo='"+sex+"', edad='"+edad+"', enfermedades='"+enfermedades+"', alergias='"+alergias+"', peso_meta='"+end+"' where id_paciente='"+idpa+"';";
            sentenciaSQL.executeUpdate(strComando);
           
                out.println("<br><br><center><h2>Expediente actualiado correctamente</h2>");
                out.println("Puedes observar los cambios en 'Ver expediente'");
