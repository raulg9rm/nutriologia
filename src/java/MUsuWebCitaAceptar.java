 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/MUsuWebCitaAceptar"})
public class MUsuWebCitaAceptar extends HttpServlet {
    ResultSet cdr = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MUsuWebCitaAceptar</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MUsuWebCitaAceptar at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        <!--================End Home Banner Area =================-->");
            //cor="SELECT * FROM usuarioweb WHERE usuario=(SELECT usuario FROM iniciosesion)";
            //out.println("<h1>ENVIADO</h1>");
            out.println("<br><br><h1>La cita se agendo</h1>");
            //correo
            out.println("");
            out.println("</br></br><button class=\"main_btn2\" onclick=\"buscarOpcionMUsuWebCitaRegresar();\">Aceptar</button><br><br><br><br>");
        } finally {
            out.close();
        }
