 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/ServDVisualizacionPacienteHistoriaExito"})
public class ServDVisualizacionPacienteHistoriaExito extends HttpServlet {
    ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServDVisualizacionPacienteHistoriaExito</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServDVisualizacionPacienteHistoriaExito at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"    ");
             ...
             out.println("<center>"
                     ...
                     + "IMAGEN DE COMO ME VEO ACTUALMENTE: <br/><img src=\""+  cdr.getString("foto") +"\" width=\"300\" height=\"250\" align=\" center\" >"
            ...
            cdr = sentenciaSQL.executeQuery(expediente);
             ...
             out.println("<center>"
                     ...
                     + "<p> PESO INICIAL:"+ cdr.getString("peso_inicial") +"</p>"
                     +"<p> PESO META:"+ cdr.getString("peso_meta") +" LOGRADO</p>"
                     + "</center><br>");
             }
            out.println("<a href='DPacienteHistoriaExito.jsp'></a><center><u><b>REGRESAR<u><b></center>");
