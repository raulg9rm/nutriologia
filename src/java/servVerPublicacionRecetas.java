 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/servVerPublicacionRecetas"})
public class servVerPublicacionRecetas extends HttpServlet {
    ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servVerPublicacionRecetas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servVerPublicacionRecetas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"<br><br>");
            out.println("<center><h1>Recetas.</h1></center>");
         ...
         out.println();
             ...
             out.println("<center>"
                     ...
                     + "<h2> Descripcion :</h2>"+ cdr.getString("descripcion") +""
