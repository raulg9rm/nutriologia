 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/MAdminSubirArchivosAlim"})
public class MAdminSubirArchivosAlim extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MAdminSubirArchivosAlim</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MAdminSubirArchivosAlim at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        <center><br><br><br>");
            out.println("<h1>SUBIR ARCHIVO DE ALIMENTO(S)</h1>");
            out.println("</br></br>Categoria:");
            out.println("</br><input type=\"radio\" name=\"opcion\" onclick=\"buscarOpcionMAdministradorSub1();\" >Categoria Existente<br><br>"
                    + "<input type=\"radio\" name=\"opcion\" onclick=\"buscarOpcionMAdministradorSub2();\" >Nueva categoria</br>");
            out.println("<div id=\"mensaje\" align=\"center\"></div><br><br></center><br><br><br><br>");
    }
