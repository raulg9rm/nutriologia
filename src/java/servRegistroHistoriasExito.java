 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/servRegistroHistoriasExito"})
public class servRegistroHistoriasExito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servRegistroHistoriasExito</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servRegistroHistoriasExito at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"    ");
        out.println("<br><center><h1>Publica tu historia de &eacute;xito ya!!</h1>"
                + "        <label>Titulo: </label>\n"
                + "        <input type=\"text\" id=\"titulo\"><br/><br/>&nbsp;&nbsp;\n"
                + "        <label>Descripci&oacute;n: </label>\n"
                + "        <textarea id=\"descripcion\"></textarea><br/><br/>&nbsp;&nbsp;\n"
                + "        <button id=\"button\" class=\"main_btn2\" onclick=\"RegresarValoresHistoria();\">PUBLICAR</button>");
       out.println("<div id=\"registroHistoria\"></div></center><br><br><br>");
    }
