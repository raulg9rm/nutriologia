 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/servVerPublicacionConsejos"})
public class servVerPublicacionConsejos extends HttpServlet {
    ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servVerPublicacionConsejos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servVerPublicacionConsejos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
        cons = "select * from publicacion where tipo_publicacion= 'consejo';";
...
"<br><br>");
            out.println("<center><h1>Los mejores consejos de nuestros nutriologos.</h1></center>");
            
         out.println();
             while(cdr.next()){
             out.println("<center>"
                     + "<h3> "+ cdr.getString("titulo")+" </h3>"
                     + "<img src=\""+  cdr.getString("foto") +"\" width=\"150\" height=\"90\" align=\" center\" >"
                     + "<p> "+ cdr.getString("descripcion") +"</p>"
                     //"<p>La cedula del nutri&oacute;logo que lo publico es:" + cdr.getString("cedula") +"</p>"
                     + "</center><br><br><br>");
             }
