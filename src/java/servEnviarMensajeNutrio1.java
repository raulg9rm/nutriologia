 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/servEnviarMensajeNutrio1"})
public class servEnviarMensajeNutrio1 extends HttpServlet {
    ResultSet cdr = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servEnviarMensajeNutrio1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servEnviarMensajeNutrio1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String usuarioPaciente = request.getParameter("usuarioPaciente");
...
"                                                                                <li class=\"nav-item\"><a class=\"nav-link\" onclick=\"buscarOpcionMNutriSubirDieta();\">Dieta personalizada</a></li>\n" +
"                                                                        </ul>\n" +
"								</li>\n" +
"								<li class=\"nav-item submenu dropdown\">\n" +
