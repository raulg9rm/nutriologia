 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/servAbrirManual"})
public class servAbrirManual extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servAbrirManual</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servAbrirManual at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        <!--================End Home Banner Area =================-->");
        out.print("<br><br>");
        out.print("<center><h2>Manual de Usuario</h2></center>");
        
        out.println("<center><embed height='600px' width='70%' toolbar='0' navpanes='0' src='manual/ManualDeUsuario.pdf'/></center>");
        out.print("<br><br>");
    }
