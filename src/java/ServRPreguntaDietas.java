 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/ServRPreguntaDietas"})
public class ServRPreguntaDietas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServRPreguntaDietas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServRPreguntaDietas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        <!--================End Home Banner Area =================-->");
        out.println("<br><br>");
        out.println("<center><button onclick=\"buscarNutriologos();\" class=\"main_btn2\">Comprar plan de dieta</button>");
        out.println("<br><br><br><button onclick=\"renovarPlanDieta();\" class=\"main_btn2\">Renovar</button></center>");
