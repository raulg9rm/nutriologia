 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/servReporteCalorias"})
public class servReporteCalorias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servReporteCalorias</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servReporteCalorias at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"        ");
        out.println("<center><br><br><h1>Ver calorias</h1>"
                + "Fecha: <input type=\"date\" id=\"fecha\" value=\"fecha\">  "
                + "<button id=\"button\" class=\"main_btn2\" onclick=\"reporteSemanalCaloriasServ1();\">Buscar</button>"
                + "</br></br><button id=\"button\" class=\"main_btn2\" onclick=\"reporteSemanalCaloriasServ2();\">Ver todas mis calorias.</button>");
     out.println("<div id=\"Reporte\"></div><br><br></center>");
    }
