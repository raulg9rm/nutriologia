 ...
 * @author Raúl
 */
@WebServlet(urlPatterns = {"/ServRegRPaciente"})
public class ServRegRPaciente extends HttpServlet {
    ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServRegRPaciente</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServRegRPaciente at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        tipo="paciente";
            ...
            String strComando2="INSERT INTO paciente VALUES (null, '" + foto +"','" +correo +"','" + usuario + "')";
            ...
            out.println("<h3>A continuación debes iniciar sesi&oacuten y una vez dentro en tu p&aacutegina principal de paciente, deberas dar clic en 'comprar dieta' para continuar con tu proceso de registro</h3><br><br>");
            
            out.println("<img src=\"img/blog/cat-post/ejemplo.png\" height='250' width='500' alt=\"ejemplo\"><br><br>");
            ...
            out.println("<h2>Registro fallido</h2>");
