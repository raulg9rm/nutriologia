					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item"><a class="nav-link" href="contact.html">¿Eres nutriólogo?</a></li>
							</ul>
						</div> 
					</div>
            	</nav>
           		...
           		<div class="banner_inner d-flex align-items-center">
					<div class="container">
						<div class="banner_content text-center">
							...
							<p>Deseas llevar un plan de nutrición de manera facil y sencilla, pues registrate y nosotros te contactamos con un nutriólogo especializado</p>
							<a class="main_btn" href="#">Registrarse</a>
						</div>
					</div>
				</div>
            </div>
