<%-- 
    Document   : DInicioSesion
    Created on : 9/06/2019, 07:37:26 PM
...
<html lang="en">
    ...
    <body>
        ...
        <section class="about_area pad_top">
            ...
            USUARIO: <input type="text" name="nombre" id="usuario" >
            <br><br>
            PASSWORD: <input type="password" name="clave" id="password" >
            <br><br>
