							...
							<div class="col-md-4">
								<div class="single-defination">
									...
									<p>P.D.No debes crear más de un expediente</p>
                                                                        <button class="main_btn2">Crear expediente</button>
								</div>
							</div>
							<div class="col-md-4">
								<div class="single-defination">
									<h4 class="mb-20">Ver</h4>
                                                                        <p>Puedes consultar tu expediente para conocer tus datos cuando lo necesites</p><br><br>
                                                                        <button class="main_btn2">Ver expediente</button>
								</div>
							</div>
							<div class="col-md-4">
								<div class="single-defination">
									...
									<p>Edita tu expediente cada que lo necesites, además puedes actualizar tu peso constantemente para tener un mejor control</p>
                                                                        <br><button class="main_btn2">Editar</button>
								</div>
							</div>
						</div>
					</div>
        			...
        			<div class="col-lg-6">
        				<div class="h_blog_text_inner left">
                                            <h1>Edita tu expediente</h1><br>
                                                                        ...
                                                                        <h3>Enfermedades</h3>
                                                                        <textarea id='enfer'></textarea>
                                                                        <h3>Alergias</h3>
                                                                        <textarea id='aler'></textarea>
                                                                        ...
                                                                        <br>
                                                                        <br>
                                                                        <button class="main_btn2" id="btnEx" onclick="editaExpediente();">Guardar cambios</button>
