					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Publicar</a>
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="elements.html">Consejo</a></li>
                                                                                <li class="nav-item"><a class="nav-link" href="elements.html">Receta</a></li>
									</ul>
								</li> 
								<li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Nombre nutriólogo</a>
									<ul class="dropdown-menu">
        		...
        		<div class="about_inner row">
        			<div class="col-lg-6">
        				<div class="about_text">
        					...
        					<form action="ServDNutriologoPubliccionRYC" method="get">
            TITULO:<input type="text" name="titulo"><br/><br/>
            CEDULA:<input type="text" name="cedula"><br/><br/><br/>
            FOTOGRAFIA:<input type="file" name="foto"><br/><br/><br/>
           TIPO: <select name="tipo">
                    <option><h2>receta<h2></option>
                    <option><h2>consejo</h2></option>
            </select><br/><br/>
            DESCRIPCION:<br/><br/>
            <textarea cols="100" rows="10" name="descripcion"></textarea><br/><br/><br/>
            <input type="submit" value="PUBLICAR" class="main_btn2">          
        </form>
        
        <br><br> <div><h3>${resp}</h3></div>
