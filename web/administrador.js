...
{
    xhr.open("GET", "ServBoletinA", true);
    xhr.onreadystatechange = verificaDetallem;
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.send(null);
}

function verificaDetalled1() {
    if (xhr.readyState == 4) {
        document.getElementById("nose").innerHTML = "<em>" + xhr.responseText + "</em>";
    }
}

function boletinServ2()
{
    var op1 = document.getElementById("o1").value;
    //alert(op1);
    xhr.open("GET", "servBoletin1", true);
...
function recomendarAmigoServ()
{
    ...
    xhr.open("GET", "serRecomendarAmigo", true);
    xhr.onreadystatechange = verificaDetalled3;
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.send(null);
}
...
{
    crearObjeto();
    recomendarAmigoServ1();
}

function recomendarAmigoServ1()
{
    var correoA = document.getElementById("correoA").value;
    xhr.open("GET", "serRecomendarAmigo1", true);
    xhr.onreadystatechange = verificaDetalled4;
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.send(null);
}
