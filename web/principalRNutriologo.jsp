...
<html lang="en">
    ...
    <body>
        <script src="scriptNutriologo4.js" type="text/javascript"></script>
        	...
        	<div  class="container">
        			...
        			<div  class="col-lg-6">
        				<div class="about_text">
        					<h3>Nuestro sitio te muestra las ganancias que has tenido por tus dietas</h3>
        					
                                                <button onclick="buscarOpcionMNutriGanancias();" class="main_btn2">Mis Ganancias</button>
        ...
        <div class="whole-wrap">
				<div class="container">
					...
					<div class="section-top-border">
                                            <center><h3 class="mb-30 title_color">Mensajes</h3>
                                                <a class="main_btn2" onclick="buscarNotificaciones();">Notificaciones</a><br><br></center><br><br><br>
						<div class="row">
							<div class="col-md-4">
								<div class="single-defination">
                                                                    <center><h4 class="mb-20">Redactar</h4></center>
                                                                        
                                                                    <center><a class="main_btn2"  onclick="enviarMensajesNutrio();">Redactar mensaje</a></center>
								</div>
							</div>
							<div class="col-md-4">
								<div class="single-defination">
									<center><h4 class="mb-20">Mis mensajes enviados</h4></center>
                                                                        ...
                                                                        <center><a class="main_btn2" onclick="verMensajesNutrio();">Ver</a></center>
								</div>
							</div>
							<div class="col-md-4">
								<div class="single-defination">
									<center><h4 class="mb-20">Mensajes recibidos</h4></center>
                                                                        ...
                                                                        <center><button class="main_btn2" onclick="verMensajesRecibidosNutrio();">Ver</button></center>
								</div>
							</div>
						</div>
					</div>
