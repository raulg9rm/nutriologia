...
<html lang="en">
    ...
    <body>
        <script src="scriptPrinci2.js" type="text/javascript"></script>
        <!--================Header Menu Area =================-->
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item"><a class="nav-link" href="regRNutriologo.jsp">¿Eres nutriólogo?</a></li>
							</ul>
						</div> 
					</div>
            	</nav>
							...
							<div class="h_blog_text">
								<div class="h_blog_text_inner left">
									<h4>Comprar dieta</h4>
                                                                        ...
                                                                        <h3>No. de tarjeta</h3>
                                                                        <input type='text' id='tarjeta'><button id='btnTar' onclick='consultarSaldo();'>Consultar Saldo</button>
                                                                        ...
                                                                        <br>
                                                                        <br>
                                                                        <button class="main_btn2" id='el' value='0' onclick='comprarDieta2();'>Comprar</button>
